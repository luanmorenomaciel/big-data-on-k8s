...
if __name__ == '__main__':
    ...
    get_users_file = "gs://owshq-processing-zone/files/users/*.json"
    get_business_file = "gs://owshq-processing-zone/files/business/*.json"
    get_reviews_file = "gs://owshq-processing-zone/files/reviews/*.json"
    ...
    # save dataframe into curated zone
    # ds_yelp - dataset saved into storage
    df_join.write.format("parquet").mode("overwrite").save("gs://owshq-curated-zone/ds_yelp")
